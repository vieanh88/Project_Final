...
def main(config_path):
    ...
    with accelerator.main_process_first():
        if config.get('pretrained_model', '') != '':
            ...
            if resume_skip_batches:
                ...
                if resume_batch_idx > 0 and accelerator.is_main_process:
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            if save_step_freq > 0 and iters % save_step_freq == 0 and accelerator.is_main_process:
                ...
                save_path = osp.join(log_dir, 'step_1st_%09d.pth' % iters)
                torch.save(state, save_path)
                _cleanup_step_checkpoints(log_dir, 'step_1st_', save_total_limit)
